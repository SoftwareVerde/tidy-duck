class InputField extends React.Component {
    ...
    renderInput() {
        switch (this.props.type) {
            ...
            default:
                return (
                    <input type={this.props.type} id={this.props.id} name={this.props.name} value={this.state.value} onChange={this.onInputChanged} readOnly={this.props.readOnly} pattern={this.props.pattern} title={this.props.title} required={this.props.isRequired} step={this.props.step} min={this.props.min} max={this.props.max} onBlur={this.props.onBlur}/>
                );
        }
    }
