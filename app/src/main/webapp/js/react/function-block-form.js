    ...
    render() {
        ...
        return (
            <div className="metadata-form" onClick={this.onClick}>
                ...
                <app.InputField id="function-block-description" name="description" type="textarea" label="Description" value={this.state.functionBlock.getDescription()} readOnly={this.props.readOnly} onChange={this.onDescriptionChange} />
