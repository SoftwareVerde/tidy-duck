    ...
    render() {
        ...
        reactComponents.push(
            <div key="input-group" className="clearfix">
                ...
                <app.InputField key="function-block-name" id="function-block-name" name="name" type="text" label="Name" value={functionBlock.getName()} readOnly={readOnly} onChange={this.onNameChanged} isRequired={true} />
                <app.InputField key="function-block-release-version" id="function-block-release-version" name="releaseVersion" type="text" label="Release" value={version} readOnly={readOnly} onChange={this.onReleaseVersionChanged} isRequired={true} />
            </div>
        );
